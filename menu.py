...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item = input("Type menu number: ")
            ...
            if(menu_item.isdigit()):
                ...
                if int(menu_item) in menu_items.keys():
                    ...
                    menu_item_name = menu_items[int(menu_item)]["Item name"]

                    # Ask the customer for the quantity of the menu item
                    item_quantity_input = input(f"How many {menu_item_name} would you like? ")

                    # Check if the quantity is a number, default to 1 if not
                    if(item_quantity_input.isdigit()):
                    ...
                    order_list.append({
                        ...
                        "Price": menu_items[int(menu_item)]["Price"],
    ...
    while True:
        ...
        if keep_ordering.lower() == "y" or keep_ordering.lower() == "yes":
            # Keep ordering
            break
        elif keep_ordering.lower() == "n" or keep_ordering.lower() == "no":
...
total_spaces_count = (25 - len(str(sum([item['Price'] * item['Quantity'] for item in order_list]))))

if(len(str(sum([item['Price'] * item['Quantity'] for item in order_list]))) > 4):
